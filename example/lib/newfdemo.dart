...
class NewFDemoWidget extends StatelessWidget {
  RouterOption routeOption;
  NewFDemoWidget(RouterOption option, {Key key}) : super(key: key) {
    routeOption = option;
  }
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("New Flutter Page(${m["id"]})"),
        ),
        body: new Center(
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              new SizedBox(width: 1.0, height: 100.0),
              new GestureDetector(
                child: new Text("Click to open new NativePage"),
                onTap: () {
                  HybridStackManagerPlugin.hybridStackManagerPlugin
                      .openUrlFromNative(url: "hrd://newndemo");
                },
              )
            ],
          ),
